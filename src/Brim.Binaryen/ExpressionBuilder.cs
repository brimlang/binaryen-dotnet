...
public sealed class ExpressionBuilder
{
  ...
  internal ExpressionBuilder(IntPtr module)
  {
    _module = module;
  }
  ...
  {
    var literal = Interop.Native.BinaryenLiteralInt32(value);
    var expr = Interop.Native.BinaryenConst(_module, literal);
  ...
  {
    var literal = Interop.Native.BinaryenLiteralInt64(value);
    var expr = Interop.Native.BinaryenConst(_module, literal);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var literal = Interop.Native.BinaryenLiteralFloat32(value);
    var expr = Interop.Native.BinaryenConst(_module, literal);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var literal = Interop.Native.BinaryenLiteralFloat64(value);
    var expr = Interop.Native.BinaryenConst(_module, literal);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenLocalGet(_module, index, type);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenLocalSet(_module, index, value.Handle);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenLocalTee(_module, index, value.Handle, type);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenGlobalGet(_module, name, type);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenGlobalSet(_module, name, value.Handle);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenUnary(_module, op, value.Handle);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenBinary(_module, op, left.Handle, right.Handle);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var handles = children.Select(e => e.Handle).ToArray();
    var expr = Interop.Native.BinaryenBlock(_module, name, handles, (uint)handles.Length, type);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenIf(_module, condition.Handle, ifTrue.Handle, 
  ...
  {
    var expr = Interop.Native.BinaryenLoop(_module, name, body.Handle);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenBreak(_module, name, 
  ...
  {
    var handles = operands.Select(e => e.Handle).ToArray();
    var expr = Interop.Native.BinaryenCall(_module, target, handles, (uint)handles.Length, returnType);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenSelect(_module, condition.Handle, ifTrue.Handle, ifFalse.Handle);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenDrop(_module, value.Handle);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenReturn(_module, value?.Handle ?? IntPtr.Zero);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenNop(_module);
    return new BinaryenExpression(expr);
  }
  ...
  {
    var expr = Interop.Native.BinaryenUnreachable(_module);
    return new BinaryenExpression(expr);
  }
}